...
<head>
    ...
    <title>Login | Kuliner Kang Aye</title>
...
<body>
    ...
    <div class="container" id="konten">
        <div class="isikonten">
            ...
            <div class="sub-title">Enter your mobile number and password to login</div>
            <form class="login100-form validate-form p-b-33 p-t-5">
                <div class="wrap-input100 validate-input" data-validate="Enter username">
                    <input class="form-control" type="text" name="username" placeholder="+62 xxxx xxxx" required>
                </div>
                ...
                <div class="container-login100 sub-title">
                    <p>Don't have an account ?
                        <a href="<?php site_url() ?>register" class="btn btn-secondary w-100 d-flex justify-content-center" id="btn-register">Register Now</a>
                    </p>
                </div>
            </form>
        </div>
